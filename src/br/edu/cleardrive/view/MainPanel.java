...
public class MainPanel extends JPanel {
	...
	private void buildHeaderPanel() {
		...
		ComponentManager.register(ComponentName.DRIVE_CHANGED_COMBOBOX.name(), listedDrives);
		ComponentManager.register(ComponentName.STATUS_PROGRESS_BAR.name(), progressBar);
		
		listedDrives.setActionCommand(ComponentName.DRIVE_CHANGED_COMBOBOX.name());
	...
	private void buildBodyPanel() {
		...
		ComponentManager.register(ComponentName.OUTPUT_VIEW_TEXT_AREA.name(), outputView);
	...
	private void buildFooterPanel() {
		...
		ComponentManager.register(ComponentName.ABOUT_BUTTON.name(), btnAbout);
		ComponentManager.register(ComponentName.PROTECT_BUTTON.name(), btnProtect);
		ComponentManager.register(ComponentName.STOP_BUTTON.name(), btnStop);
		ComponentManager.register(ComponentName.RECOVER_BUTTON.name(), btnRecovery);
		
		btnAbout.addActionListener(buttonEventHandler);
		btnAbout.setActionCommand(ComponentName.ABOUT_BUTTON.name());
		
		btnProtect.addActionListener(buttonEventHandler);
		btnProtect.setActionCommand(ComponentName.PROTECT_BUTTON.name());
		
		btnStop.addActionListener(buttonEventHandler);
		btnStop.setActionCommand(ComponentName.STOP_BUTTON.name());
		
		btnRecovery.addActionListener(buttonEventHandler);
		btnRecovery.setActionCommand(ComponentName.RECOVER_BUTTON.name());
